...
pub fn log_args(level: log::Level) {
    ...
    log!(
        level,
        "  dir_cache_expiry_secs:   {}s",
        args.dir_cache_expiry_secs
    );
    log!(
        level,
        "  file_cache_expiry_secs:  {}s",
        args.file_cache_expiry_secs
    );
    log!(level, "Timer values..........................");
    log!(
        level,
        "  dir_reread_timeout_secs:   {}s",
        args.dir_reread_timeout_secs
    );
    log!(
        level,
        "  file_reread_timeout_secs:  {}s",
        args.file_reread_timeout_secs
    );
    log!(
        level,
        "  dir_read_sleep_ms:         {}ms",
        args.dir_read_sleep_ms
    );
    log!(
        level,
        "  file_read_sleep_ms:        {}ms",
    ...
    log!(level, "  dir_attr_ttl_ms:     {}ms", args.dir_attr_ttl_ms);
    log!(level, "  file_attr_ttl_ms:    {}ms", args.file_attr_ttl_ms);
    log!(level, "  dir_lookup_ttl_ms:   {}ms", args.dir_lookup_ttl_ms);
    log!(
        level,
        "  file_lookup_ttl_ms:  {}ms",
